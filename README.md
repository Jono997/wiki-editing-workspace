...
Step 6. Open up the Command Palette (Ctrl+P) and run the command `>Terminals: Run` (this will have to be repeated whenever the terminal closes for whatever reason)
...
- Fixed a typo in the command help